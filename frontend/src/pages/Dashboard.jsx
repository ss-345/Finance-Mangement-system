...
const Dashboard = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8">
              ...
              <tbody>
                {trends.map((t) => (
                  ...
                  >
                    ...
                    <td
                      className={`py-2 font-semibold ${t.net >= 0 ? "text-blue-600" : "text-red-600"}`}
                    >
      ...
      {/* Category Totals (analyst/admin only) */}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-gray-500 border-b">
                  ...
                  <th className="pb-2 font-medium text-red-500">Expense</th>
                  <th className="pb-2 font-medium text-blue-600">Net</th>
                  <th className="pb-2 font-medium text-gray-400">Count</th>
                </tr>
              </thead>
              <tbody>
                {categoryTotals.map((c) => (
                  ...
                  >
                    ...
                    <td
                      className={`py-2 font-semibold ${c.net >= 0 ? "text-blue-600" : "text-red-600"}`}
                    >
            ...
            {recent.map((t) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <span
                    className={`w-2 h-2 rounded-full ${t.type === "income" ? "bg-emerald-500" : "bg-red-500"}`}
                  />
                  <div>
